  ...
  <div>
    <el-card class="table-card">
      ...
      >
        ...
        <el-table-column prop="groundingNum" label="到货数量" width="160">
        </el-table-column>
        ...
        <el-table-column prop="realDifferenceNum" label="收货差异" width="160">
        </el-table-column>
      </el-table>
      <!--   分页   -->
...
<script>
import { pagingQueryInventoryListingSubsidiary } from "@/api/list-in";
