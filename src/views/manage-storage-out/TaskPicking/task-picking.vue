  ...
  <div>
    <el-card>
      ...
      >
        <el-row :gutter="30">
          <el-col :span="6">
            <el-form-item label="拣货编号" prop="code">
              <el-input
                placeholder="请输入"
          ...
          <el-col :span="6">
            <el-form-item label="收货状态" prop="status">
              ...
              >
                ...
                <el-option label="拣货中" value="2"></el-option>
                <el-option label="拣货完成" value="3"></el-option>
              </el-select>
            </el-form-item>
          </el-col>
    ...
    <el-card class="table-card">
      ...
      >
        ...
        <el-table-column prop="pickingNum" label="拣货数量" width="160">
        </el-table-column>
        <el-table-column
          :filters="[
            { text: '待分配', value: 1 },
        ...
        <el-table-column sortable prop="realNum" label="实拣数量" width="160">
        </el-table-column>
        <el-table-column
          sortable
          prop="completionTime"
...
export default {
  ...
  created() {
    this.pagingQueryPickingTaskDetails();
  },
  methods: {
    ...
    async generateProfitsLossesTheSingle() {
      if (this.multipleSelection.length === 0) {
        ...
        const res = await pickingComplete(this.multipleSelection);
    ...
    async pickingTaskDistribution() {
      ...
      await this.pagingQueryPickingTaskDetails();
    ...
    // 分页查询仓库
    async pagingQueryPickingTaskDetails() {
      try {
        const { data } = await pagingQueryPickingTaskDetails(
          this.listFormLabel
        );
